...
module IFFT64pt_wrapper(
    ...
    wire signed [15:0] complex_in_data_imag;//To use FFT IP as IFFT make data_fft as complex conjugate
    assign complex_in_data_imag = ~in_data_imag + 1;
    assign data_fft = {complex_in_data_imag, in_data_real};
