...
HD_PWD='C:/Users/nages/verilog_projects/Combinational Circuits/Comparator/Comparator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_2_comparator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bit_2_comparator.tcl -notrace
