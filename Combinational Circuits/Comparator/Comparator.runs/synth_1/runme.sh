...
HD_PWD='C:/Users/nages/verilog_projects/Combinational Circuits/Comparator/Comparator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_2_comparator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit_2_comparator.tcl
