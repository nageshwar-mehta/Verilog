...
HD_PWD='C:/Users/nages/verilog_projects/FFT-IP/FFT-IP.runs/fft_64_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_64.tcl
