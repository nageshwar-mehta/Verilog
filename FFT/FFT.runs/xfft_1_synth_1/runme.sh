...
HD_PWD='C:/Users/nages/verilog_projects/FFT/FFT.runs/xfft_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xfft_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xfft_1.tcl
