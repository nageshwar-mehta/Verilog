...
HD_PWD='C:/Users/nages/verilog_projects/FFT64pt_fixed_point/FFT64pt_fixed_point.runs/xfft_1_new_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xfft_1_new.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xfft_1_new.tcl
