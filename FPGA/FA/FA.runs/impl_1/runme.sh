...
HD_PWD='C:/Users/nages/verilog_projects/FPGA/FA/FA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RCA_2_stage.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RCA_2_stage.tcl -notrace
