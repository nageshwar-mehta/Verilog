...
HD_PWD='C:/Users/nages/verilog_projects/FPGA/FA/FA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RCA_2_stage.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RCA_2_stage.tcl
