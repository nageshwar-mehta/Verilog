...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../Fixed posit multiplier.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../Fixed posit multiplier.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
