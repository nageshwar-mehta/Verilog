...
HD_PWD='C:/Users/nages/verilog_projects/Fixed posit multiplier/Fixed posit multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fixed_posit_m1_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fixed_posit_m1_tb.tcl -notrace
