...
HD_PWD='C:/Users/nages/verilog_projects/tutorial projects/NAND_using_OR/NAND_using_OR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NAND.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NAND.tcl
