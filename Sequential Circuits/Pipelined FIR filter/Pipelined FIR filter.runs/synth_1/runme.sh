...
HD_PWD='C:/Users/nages/verilog_projects/Sequential Circuits/Pipelined FIR filter/Pipelined FIR filter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stage_4_FIR_Filter_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stage_4_FIR_Filter_tb.tcl
