...
HD_PWD='C:/Users/nages/verilog_projects/Sequential Circuits/clock dividers/clock dividers.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Fby2divider.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Fby2divider.tcl -notrace
