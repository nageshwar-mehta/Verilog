...
HD_PWD='C:/Users/nages/verilog_projects/Sequential Circuits/clock dividers/clock dividers.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fby2divider.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fby2divider.tcl
